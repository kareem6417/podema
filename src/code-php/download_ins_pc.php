...
$totalScore = $row['age_score'] + $row['casing_lap_score'] + $row['layar_lap_score'] + $row['booting_lap_score'] + $row['multi_lap_score'] + $row['port_lap_score'] + $row['audio_lap_score'] + $row['software_lap_score'];
$pdf->SetFont('helvetica', 'B', 11);
