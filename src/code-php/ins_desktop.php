...
<head>
  ...
  <title>Inspection - PC Desktop</title>
  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full" data-sidebar-position="fixed" data-header-position="fixed">
    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        <div class="card">
          <div class="card-body">
            <h1 class="card-title fw-semibold mb-4">Device Inspection (PC Desktop)</h1>
            <form id="assessmentForm" method="post" action="submit_ins_desktop.php" enctype="multipart/form-data">
              ...
              <div class="card form-section-card">
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6 mb-3"><label for="jenis" class="form-label">Device Type<span class="required-star">*</span></label><input type="text" id="jenis" name="jenis" class="form-control" value="PC Desktop" readonly></div>
              ...
              <div class="card form-section-card">
                  <div class="card-body">
                      <h5 class="mb-3">Parameter Inspeksi Fisik</h5>
                      <div class="row">
                          <div class="col-md-6 mb-3">
                              <label for="age" class="form-label">Usia Perangkat<span class="required-star">*</span></label>
                          ...
                          <div class="col-md-6 mb-3">
                              <label for="layar_lap" class="form-label">Layar (Monitor)<span class="required-star">*</span></label>
