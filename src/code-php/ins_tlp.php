...
<head>
  ...
  <title>Inspection - Telephone</title>
              ...
              <div class="card form-section-card">
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6 mb-3"><label for="jenis" class="form-label">Device Type<span class="required-star">*</span></label><input type="text" id="jenis" name="jenis" class="form-control" value="Telephone" readonly></div>
