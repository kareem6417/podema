...
<head>
  ...
  <title>Inspection - Printer</title>
        ...
        <div class="card">
          <div class="card-body">
            ...
            <form id="assessmentForm" method="post" action="submit_printer.php" enctype="multipart/form-data">
              ...
              <div class="card form-section-card">
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6 mb-3"><label for="jenis" class="form-label">Device Type<span class="required-star">*</span></label><input type="text" id="jenis" name="jenis" class="form-control" value="Printer" readonly></div>
              ...
              <div class="card form-section-card">
                  <div class="card-body">
                      <h5 class="mb-3">Parameter Inspeksi Printer</h5>
                      <div class="row">
                          <div class="col-md-6 mb-3">
                          ...
                          <div class="col-md-6 mb-3">
                              <label for="ink_pad" class="form-label">Ink Pad<span class="required-star">*</span></label>
                              <select id="ink_pad" name="layar_lap" class="form-select" required>
                                  <option value="">--- Pilih ---</option>
                                  <?php $options = fetchData("ins_ink_pad"); foreach ($options as $opt) { echo '<option value="' . $opt['ink_pad_score'] . '">' . $opt['ink_pad_name'] . '</option>'; } ?>
                              </select>
                          </div>
                      </div>
                  </div>
