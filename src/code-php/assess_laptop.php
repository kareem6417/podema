        ...
        <div class="card">
          <div class="card-body">
            ...
            <form id="assessmentForm" method="post" action="submit.php">
              ...
              <div class="card form-section-card">
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6 mb-3"><label for="type" class="form-label">Merk/Type<span class="required-star">*</span></label><input type="text" id="type" name="type" class="form-control" required></div>
              ...
              <div class="card form-section-card">
                  <div class="card-body">
                      <h5 class="mb-3">Parameter Perangkat Lunak & Usia</h5>
                      <div class="row">
                          <div class="col-md-6 mb-3">
                              ...
                              <select id="os" name="os" class="form-select" required>
                                  ...
                                  <?php $options = fetchData("operating_sistem_laptop"); foreach ($options as $opt) { echo '<option value="' . $opt['os_score'] . '">' . $opt['os_name'] . '</option>'; } ?>
                              </select>
                          </div>
                          <div class="col-md-6 mb-3">
                              ...
                              <select id="processor" name="processor" class="form-select" required>
                                  <option value="">--- Select ---</option>
                                  <?php $options = fetchData("processor_laptop"); foreach ($options as $opt) { echo '<option value="' . $opt['processor_score'] . '">' . $opt['processor_name'] . '</option>'; } ?>
                              </select>
                          </div>
                          <div class="col-md-6 mb-3">
                          ...
                          <div class="col-md-6 mb-3">
                              ...
                              <select id="issue" name="issue" class="form-select" required>
                                  <option value="">--- Select ---</option>
                                  <?php $options = fetchData("issue_software_laptop"); foreach ($options as $opt) { echo '<option value="' . $opt['issue_score'] . '">' . $opt['issue_name'] . '</option>'; } ?>
                              </select>
                          </div>
                      </div>
                  </div>
              ...
              <div class="card form-section-card">
                  <div class="card-body">
                      <h5 class="mb-3">Parameter Perangkat Keras</h5>
                      <div class="row">
                          <div class="col-md-6 mb-3">
                              <label for="ram" class="form-label">RAM<span class="required-star">*</span></label>
                              <select id="ram" name="ram" class="form-select" required>
                                  <option value="">--- Select ---</option>
                                  <?php $options = fetchData("ram_laptop"); foreach ($options as $opt) { echo '<option value="' . $opt['ram_score'] . '">' . $opt['ram_name'] . '</option>'; } ?>
                              </select>
                          </div>
                          <div class="col-md-6 mb-3">
                              ...
                              <select id="storage" name="storage" class="form-select" required>
                                  <option value="">--- Select ---</option>
                                  <?php $options = fetchData("storage_laptop"); foreach ($options as $opt) { echo '<option value="' . $opt['storage_score'] . '">' . $opt['storage_name'] . '</option>'; } ?>
                              </select>
                          </div>
                          <div class="col-md-6 mb-3">
                          ...
                          <div class="col-md-6 mb-3">
                              <label for="batterylife" class="form-label">Battery Life (Without Power)<span class="required-star">*</span></label>
                              <select id="batterylife" name="batterylife" class="form-select" required>
                                  <option value="">--- Select ---</option>
                                  <?php $options = fetchData("batterylife_laptop"); foreach ($options as $opt) { echo '<option value="' . $opt['battery_score'] . '">' . $opt['battery_name'] . '</option>'; } ?>
                              </select>
                          </div>
                          <div class="col-md-6 mb-3">
                              <label for="keyboard" class="form-label">Keyboard<span class="required-star">*</span></label>
                              <select id="keyboard" name="keyboard" class="form-select" required>
                                  <option value="">--- Select ---</option>
                                  <?php $options = fetchData("keyboard_laptop"); foreach ($options as $opt) { echo '<option value="' . $opt['keyboard_score'] . '">' . $opt['keyboard_name'] . '</option>'; } ?>
                              </select>
                          </div>
                          <div class="col-md-6 mb-3">
                              <label for="screen" class="form-label">Screen<span class="required-star">*</span></label>
                              <select id="screen" name="screen" class="form-select" required>
                                  <option value="">--- Select ---</option>
                                  <?php $options = fetchData("screen_laptop"); foreach ($options as $opt) { echo '<option value="' . $opt['screen_score'] . '">' . $opt['screen_name'] . '</option>'; } ?>
                              </select>
                          </div>
                           <div class="col-md-6 mb-3">
                              <label for="touchpad" class="form-label">Touchpad<span class="required-star">*</span></label>
                              <select id="touchpad" name="touchpad" class="form-select" required>
                                  <option value="">--- Select ---</option>
                                  <?php $options = fetchData("touchpad_laptop"); foreach ($options as $opt) { echo '<option value="' . $opt['touchpad_score'] . '">' . $opt['touchpad_name'] . '</option>'; } ?>
                              </select>
                          </div>
                          <div class="col-md-6 mb-3">
                              <label for="audio" class="form-label">Audio<span class="required-star">*</span></label>
                              <select id="audio" name="audio" class="form-select" required>
                                  <option value="">--- Select ---</option>
                                  <?php $options = fetchData("audio_laptop"); foreach ($options as $opt) { echo '<option value="' . $opt['audio_score'] . '">' . $opt['audio_name'] . '</option>'; } ?>
                              </select>
                          </div>
                           <div class="col-md-6 mb-3">
                              <label for="body" class="form-label">Body<span class="required-star">*</span></label>
                              <select id="body" name="body" class="form-select" required>
                                  <option value="">--- Select ---</option>
                                  <?php $options = fetchData("body_laptop"); foreach ($options as $opt) { echo '<option value="' . $opt['body_score'] . '">' . $opt['body_name'] . '</option>'; } ?>
                              </select>
                          </div>
                      </div>
                  </div>
