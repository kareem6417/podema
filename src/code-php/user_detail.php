                  ...
                  if (isset($assessment_result)) {
                      if ($assessment_result->num_rows > 0) {
                          ...
                          while ($assessment_row = $assessment_result->fetch_assoc()) {
                              ...
                              echo "<tr><td>Sistem Operasi</td><td>" . $assessment_row["os"] . " (Skor: " . $form_inspeksi_row["os_score"] . ")</td></tr>";
                              echo "<tr><td>Processor</td><td>" . $assessment_row["processor"] . " (Skor: " . $form_inspeksi_row["processor_score"] . ")</td></tr>";
                              echo "<tr><td>Ketahanan Baterai (Tanpa Daya)</td><td>" . $assessment_row["batterylife"] . " (Skor: " . $form_inspeksi_row["battery_score"] . ")</td></tr>";
                              echo "<tr><td>Usia Perangkat</td><td>" . $assessment_row["age"] . " (Skor: " . $form_inspeksi_row["age_score"] . ")</td></tr>";
                              echo "<tr><td>Isue Terkait Software</td><td>" . $assessment_row["issue"] . " (Skor: " . $form_inspeksi_row["issue_score"] . ")</td></tr>";
                              echo "<tr><td>RAM</td><td>" . $assessment_row["ram"] . " (Skor: " . $form_inspeksi_row["ram_score"] . ")</td></tr>";
                              echo "<tr><td>VGA</td><td>" . $assessment_row["vga"] . " (Skor: " . $form_inspeksi_row["vga_score"] . ")</td></tr>";
                              echo "<tr><td>Penyimpanan</td><td>" . $assessment_row["storage"] . " (Skor: " . $form_inspeksi_row["storage_score"] . ")</td></tr>";
                              echo "<tr><td>Keyboard</td><td>" . $assessment_row["keyboard"] . " (Skor: " . $form_inspeksi_row["keyboard_score"] . ")</td></tr>";
                              echo "<tr><td>Layar</td><td>" . $assessment_row["screen"] . " (Skor: " . $form_inspeksi_row["screen_score"] . ")</td></tr>";
                              echo "<tr><td>Touchpad</td><td>" . $assessment_row["touchpad"] . " (Skor: " . $form_inspeksi_row["touchpad_score"] . ")</td></tr>";
                              echo "<tr><td>Audio</td><td>" . $assessment_row["audio"] . " (Skor: " . $form_inspeksi_row["audio_score"] . ")</td></tr>";
                              echo "<tr><td>Rangka</td><td>" . $assessment_row["body"] . " (Skor: " . $form_inspeksi_row["body_score"] . ")</td></tr>";
                  ...
                  if (isset($assessmentpc_result)) {
                      if ($assessmentpc_result->num_rows > 0) {
                          ...
                          while ($assessmentpc_row = $assessmentpc_result->fetch_assoc()) {
                              ...
                              echo "<tr><td>Sistem Operasi</td><td>" . $assessmentpc_row["os"] . " (Skor: " . $form_inspeksi_row["os_score"] . ")</td></tr>";
                              echo "<tr><td>Processor</td><td>" . $assessmentpc_row["processor"] . " (Skor: " . $form_inspeksi_row["processor_score"] . ")</td></tr>";
                              echo "<tr><td>VGA</td><td>" . $assessmentpc_row["vga"] . " (Skor: " . $form_inspeksi_row["vga_score"] . ")</td></tr>";
                              echo "<tr><td>Usia Perangkat</td><td>" . $assessmentpc_row["age"] . " (Skor: " . $form_inspeksi_row["age_score"] . ")</td></tr>";
                              echo "<tr><td>Isu Terkait Software</td><td>" . $assessmentpc_row["issue"] . " (Skor: " . $form_inspeksi_row["issue_score"] . ")</td></tr>";
                              echo "<tr><td>RAM</td><td>" . $assessmentpc_row["ram"] . " (Skor: " . $form_inspeksi_row["ram_score"] . ")</td></tr>";
                              echo "<tr><td>Penyimpanan</td><td>" . $assessmentpc_row["storage"] . " (Skor: " . $form_inspeksi_row["storage_score"] . ")</td></tr>";
                              echo "<tr><td>Tipe Monitor</td><td>" . $assessmentpc_row["typemonitor"] . " (Skor: " . $form_inspeksi_row["monitor_score"] . ")</td></tr>";
                              echo "<tr><td>Ukuran Monitor</td><td>" . $assessmentpc_row["sizemonitor"] . " (Skor: " . $form_inspeksi_row["size_score"] . ")</td></tr>";
