...
<head>
  ...
  <title>Inspection - Infrastructure</title>
        ...
        <div class="card">
          <div class="card-body">
            ...
            <form id="assessmentForm" method="post" action="submit_ins.php" enctype="multipart/form-data">
              ...
              <div class="card form-section-card">
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                      <label for="name" class="form-label">PIC/Department Name<span class="required-star">*</span></label>
                      <div class="input-group">
                        <span class="input-group-text"><i class="ti ti-user"></i></span>
                        <select id="name" name="nama_user" class="form-select" required>
                            <option value="">--- Select User/Dept ---</option>
              ...
              <div class="card form-section-card">
                <div class="card-body">
                  <h5 class="mb-3">Detail Perangkat</h5>
                  <div class="row">
                    <div class="col-md-6 mb-3">
                        <label for="status" class="form-label">Division<span class="required-star">*</span></label>
